...
namespace Specify.Chill
{
    public class ChillMethodNameStepScanner : MethodNameStepScanner
    {
        public ChillMethodNameStepScanner()
            : base(CleanupTheStepText)
        {
            ...
            AddMatcher(new MethodNameMatcher(s => s.StartsWith("Given", StringComparison.OrdinalIgnoreCase) && s != "Given", ExecutionOrder.SetupState));
            ...
            AddMatcher(new MethodNameMatcher(s => s.StartsWith("When", StringComparison.OrdinalIgnoreCase) && s != "When", ExecutionOrder.Transition));
            ...
            AddMatcher(new MethodNameMatcher(s => s.StartsWith("Then", StringComparison.OrdinalIgnoreCase) && s != "TheNamed", ExecutionOrder.Assertion) { Asserts = true });
