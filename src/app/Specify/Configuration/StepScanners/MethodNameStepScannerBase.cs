...
{
    public class MethodNameStepScannerBase : IStepScanner
    {
        private readonly Func<string, string> _stepTextTransformer;
        private readonly List<MethodNameMatcher> _matchers;

        public MethodNameStepScannerBase(Func<string, string> stepTextTransformer, params MethodNameMatcher[] matchers)
        {
            _stepTextTransformer = stepTextTransformer;
            _matchers = matchers.ToList();
        }

        public MethodNameStepScannerBase(Func<string, string> stepTextTransformer)
        {
            _stepTextTransformer = stepTextTransformer;
